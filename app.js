// ===== Config =====
const DEFAULT_BACKEND_URL = window.location.protocol === 'https:' ? '/api' : 'http://node4.dayy.web.id:2022';
...
function renderVideoCard(data) {
  ...
  if (isTikTokVideo) {
    ...
    if (data.thumbnail) {
      ...
      const backendBase = window.location.protocol === 'https:' ? '/api' : 'http://node4.dayy.web.id:2022';
